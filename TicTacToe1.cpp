...
int main()
{
	...
	while (!win)
		...
		if (isPlayerOne)
		{
			tictacspace[rowOptions - 1][columnOptions - 1] = 'X';
		}
		else
		{
			tictacspace[rowOptions - 1][columnOptions - 1] = 'O';
		}
		...
		else if (tictacspace[0][2] == 'X' && tictacspace[1][1] == 'X' && tictacspace[2][0] == 'X')
		{
			cout << "Player One Wins!"
				<< "\nGame is Over.";
			win = true;
		...
		else if (tictacspace[0][2] == 'O' && tictacspace[1][1] == 'O' && tictacspace[2][0] == 'O')
		{
			cout << "Player Two Wins!"
				<< "\nGame is Over.";
			win = true;
